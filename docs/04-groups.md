...
3. **Add members** 버튼을 클릭합니다.
   ...
   ![그룹 Members 탭](../assets/screenshots/04-groups/03-group-members-tab.png)
...
5. **Add** 버튼을 클릭하면 멤버가 추가됩니다.
   ...
   ![멤버 추가 완료](../assets/screenshots/04-groups/04-member-added.png)
...
1. `onboarding_analytics_team` 그룹 상세 페이지에서 **Permissions** 탭을 클릭합니다.
   ...
   ![그룹 Permissions 탭](../assets/screenshots/04-groups/05-group-permissions-tab.png)
...
5. **Add** 버튼을 클릭합니다.
   ...
   ![그룹 관리 권한 위임 완료](../assets/screenshots/04-groups/06-grant-manage-permission.png)
...
2. 워크스페이스 목록에서 실습에 사용할 워크스페이스(예: `coupang-appdemo`)를 클릭합니다.
   ...
   ![워크스페이스 목록](../assets/screenshots/04-groups/07-workspaces-list.png)
   *📸 캡처 안내: 계정 콘솔 > Workspaces 목록 화면. 워크스페이스 목록이 나열된 상태.*

3. 상단 탭에서 **Permissions** 탭을 클릭합니다.

   ![워크스페이스 Permissions 탭](../assets/screenshots/04-groups/08-workspace-permissions-tab.png)
...
7. **Save** 버튼을 클릭합니다.
   ...
   ![그룹 워크스페이스 할당 완료](../assets/screenshots/04-groups/09-group-added-to-workspace.png)
