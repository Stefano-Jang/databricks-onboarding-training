...
⬅️ [이전: Streamlit→대시보드 데모(시청용)](./12-streamlit-genie-demo.md) | 🏠 [목차](../README.md)

# 13. Snowflake vs Databricks Q&A
...
| 난이도 | 입문 |
| 사전 준비 | 앞의 01~12 실습을 한 번 훑어보면 이해가 쉽습니다(필수 아님) |
| 필요 권한 | 없음(개념 학습 자료) |
...
![레이크하우스 vs 데이터 웨어하우스 비교 다이어그램(플레이스홀더)](../assets/screenshots/13-snowflake-qa/01-lakehouse-vs-dw.png)
...
- 실전 감을 키우려면, [06. 테이블·Volume·RBAC/ABAC](./06-tables-volumes-rbac-abac.md)와 [08. SQL 작성·저장](./08-sql.md)을 실제 데이터로 다시 따라 해 보세요.
