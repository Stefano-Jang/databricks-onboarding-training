...
축하합니다 — 이 문서로 **온보딩 커리큘럼(01~14)을 모두 마쳤습니다!** 🎉
...
- **학생 · 취미 개발자 · 입문자**를 위한 버전으로, 학습과 개인 프로젝트에 적합합니다.

**무엇을 해 볼 수 있나요?** (이 교육에서 배운 것 대부분을 그대로!)
- 노트북에서 **Python · SQL** 작성·실행 및 협업
- **SQL 분석**, **AI/BI 대시보드**, 자연어로 데이터에 묻는 **Genie**
- **ML 모델**과 **AI 에이전트** 만들기, 내장 **AI 코딩 어시스턴트**
- **ETL·데이터 엔지니어링 파이프라인** 설계

**알아둘 점 (제약)**
- 컴퓨트·웨어하우스는 **소규모**로 제한되고 **공정 사용(fair use)** 한도가 있습니다.
- **상업적(프로덕션) 용도로는 사용할 수 없습니다** — 어디까지나 학습·실험용입니다.
- 기간이 정해진 **무료 평가판(Trial)**과 달리 Free Edition은 **영구 무료**입니다. (기존 **Community Edition** 계정은 Free Edition으로 전환되는 중이며 연말까지 유지됩니다.)

> 👉 **지금 시작하기**: <https://www.databricks.com/learn/free-edition>

무엇이든 **직접 만들어 보는 것**이 가장 빠른 학습법입니다. 즐거운 실습 되세요! 🚀
